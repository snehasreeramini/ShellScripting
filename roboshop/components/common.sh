...
sed -i -e 's/MONGO_DNSNAME/mongodb.roboshopinternal/' -e 's/REDIS_ENDPOINT/redis.roboshopinternal' -e 's/MONGO_ENDPOINT/mongodb.roboshopinternal' -e 's/CATALOGUE_ENDPOINT/catalogue.roboshopinternal'
